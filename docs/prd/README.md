...
- [0011 — Calculadora de caramelos](0011-candy-calculator.md) — cuántos caramelos y fragmentos de sueño cuesta subir un Pokémon de un nivel a otro, según su categoría y el efecto de su naturaleza sobre la EXP; herramienta efímera, sin sesión ni persistencia. *(Escrito en español por excepción.)*
