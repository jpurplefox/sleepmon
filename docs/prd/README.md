...
- [0011 — Player progress](0011-player-progress.md) — declare once, on your account, what you actually have in the game: pot step, recipe levels, a favorite recipe per dish type, and an area bonus per area; Team Analysis starts from it and offers to save back what you change there.
