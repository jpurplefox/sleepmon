...
export const UI: Record<Lang, Record<string, string>> = {
  es: {
    ...
    "expCalc.result.totalExp": "Experiencia total: {n} EXP",
    "expCalc.result.boostedNote": "Tope del Mini Boost: {n} caramelos con boost; el resto a costo normal.",
  ...
  en: {
    ...
    "expCalc.result.totalExp": "Total experience: {n} EXP",
    "expCalc.result.boostedNote": "Mini Boost cap: {n} candies boosted; the rest at normal cost.",
