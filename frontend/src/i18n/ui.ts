...
export const UI: Record<Lang, Record<string, string>> = {
  es: {
    ...
    "teams.rating.aria": "Rating de Snorlax en {island}: {tier} {level}",
    "teams.rating.toNext": "faltan {remaining} para el siguiente rating",
  ...
  en: {
    ...
    "teams.rating.aria": "Snorlax rating on {island}: {tier} {level}",
