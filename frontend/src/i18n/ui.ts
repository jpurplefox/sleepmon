...
export const UI: Record<Lang, Record<string, string>> = {
  es: {
    ...
    "box.randomIngredientsAria": "Más {value} ingredientes al azar por día por la main skill",
  ...
  en: {
    ...
    "box.randomIngredientsAria": "Plus {value} random ingredients per day from the main skill",
