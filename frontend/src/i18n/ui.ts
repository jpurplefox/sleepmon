...
export const UI: Record<Lang, Record<string, string>> = {
  es: {
    ...
    "teams.fillersTotal": "Fillers",
    "teams.cookingStrength": "Fuerza de cocina",
    "teams.potCapacity": "Capacidad de pote",
    "teams.potBase": "Base",
    "teams.potSkill": "Expansión skill",
    "teams.usedByRecipes": "Usado por recetas",
    "teams.fillersLabel": "Fillers",
    "teams.fillersStrength": "Fuerza de fillers",
    ...
    "teams.memberRanking": "Aporte por miembro",
    "teams.berryStrength": "Fuerza de bayas",
    "teams.total": "Total",
    "teams.otherSkills": "Otras habilidades",
    ...
    "expCalc.result.totalExp": "{n} EXP en el tramo · no se guarda nada.",
    "expCalc.result.boostedNote": "{n} caramelos con boost (tope 350); el resto a costo normal.",
    "expCalc.empty": "Elegí un nivel actual y uno deseado para ver el costo.",
    "expCalc.error.range": "El nivel deseado debe ser mayor que el actual (máximo 70).",
  },
  en: {
    // Common
    "common.retry": "Retry",
    ...
    "teams.potCapacity": "Pot capacity",
    "teams.potBase": "Base",
    "teams.potSkill": "Skill expansion",
    "teams.usedByRecipes": "Used by recipes",
    "teams.fillersLabel": "Fillers",
    "teams.fillersStrength": "Fillers strength",
    ...
    "teams.memberRanking": "By member",
    "teams.berryStrength": "Berries strength",
    "teams.total": "Total",
    "teams.otherSkills": "Other skills",
    ...
    "expCalc.result.totalExp": "{n} EXP over the span · nothing is saved.",
    "expCalc.result.boostedNote": "{n} candies boosted (cap 350); the rest at normal cost.",
    "expCalc.empty": "Set a current and target level to see the cost.",
    "expCalc.error.range": "Target level must be higher than current (max 70).",
  },
};
